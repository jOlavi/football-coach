...
export function Sidebar({ mobileOpen = false, onMobileClose }: SidebarProps) {
  ...
  return (
    <aside className={`shrink-0 bg-gray-900 dark:bg-slate-950 flex flex-col transition-all duration-200 h-full
      ...
      {/* Nav */}
      <nav className="flex-1 min-h-0 py-2 px-2 overflow-y-auto overflow-x-visible">
