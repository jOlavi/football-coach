              ...
              <div className="flex flex-wrap items-center gap-1.5 mt-1">
                ...
                {ownTeam && (
                  <span
                    ...
                    style={{ backgroundColor: ownTeam.color ?? '#374151' }}
                  >
                    {ownTeam.name}
                  </span>
                )}
                ...
                {m.teamLevel && <span className="text-xs bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-slate-300 rounded-full px-2 py-0.5 font-medium">{m.teamLevel === 'taso1' ? 'T1' : 'T2'}</span>}
